...
$^{\P}$ TrackCraft3R~\cite{trackcraft3r} evaluated with our standard pipeline on all 150 clips (50 per subset).
The near-zero drivetrack score reflects out-of-distribution failure: TCR's Wan2.1 video-diffusion backbone
is trained on indoor/studio content, and outdoor ego-motion (drivetrack) is OOD.

...
\begin{tikzpicture}[
  ...
  % ── output heads ──────────────────────────────────────────────────
  \node[block, above right=10mm and 20mm of ssm] (duv) {$\Delta\mathbf{u}$~head\\{\scriptsize 0-init, $\tanh\!\cdot\!2$}};
  \node[block, below right=10mm and 20mm of ssm] (dz)  {$\Delta\!\log z$~head\\{\scriptsize 0-init}};
  % ── outputs ───────────────────────────────────────────────────────
  ...
  % ── depth map bypass ──────────────────────────────────────────────
  \node[io, below left=8mm and 3mm of dz] (dm) {depth map (DA3)};
  % ── arrows ────────────────────────────────────────────────────────
  \draw[arr] (uv0) -- (in1);

...
TrackCraft3R~\cite{trackcraft3r} (CVPR~2025) repurposes the Wan2.1-T2V-1.3B video diffusion
...
Our best model v35 outperforms TCR on absolute metric-AJ by $12\times$ overall
($23.4\%$ vs $2.0\%$) and by $16\times$ on drivetrack ($13.0\%$ vs $0.2\%$) where TCR
effectively fails.
...
scale-invariant). Higher is better. ``bidir'' = bidirectional SEA-RAFT flow (reversed-video backward pass).

...
\begin{tikzpicture}[
  ...
  \node[block, above right=10mm and 35mm of ssm] (dz)  {$\Delta\!\log z$~head\\{\scriptsize 0-init}};
  \node[block, below right=10mm and 35mm of ssm] (duv) {$\Delta\mathbf{u}$~head\\{\scriptsize 0-init, $\tanh\!\cdot\!2$}};
  % ── outputs ───────────────────────────────────────────────────────
  ...
  \draw[arr] (dz)  -- (zout);
  \draw[arr] (duv) -- (uvout);
  \draw[arr] (dm.north) -- ($(dm.north -| zout.west)+(-3mm,0)$) -- ($(zout.west)+(-3mm,0)$) -- (zout.west);

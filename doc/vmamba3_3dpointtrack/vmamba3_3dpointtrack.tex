...
\caption{TAPVid-3D minival, median-scaled 3D-AJ (standard leaderboard metric; higher better).
         ``---'' = result unavailable.
         Values in parentheses are taken directly from the respective papers;
         all other numbers are produced by our own evaluation pipeline.}
\label{tab:median}
\begin{tabular}{lrrrr}
\toprule
...
$^{*}$ SpatialTrackerV2 evaluated with $s_{\text{wind}}{=}60$ on RTX\,4080\,Laptop (12\,GB); see Table~\ref{tab:median} footnote.}
\end{table}
